...
router.delete("/superimunisasi/delete/:id", dokumenController.deleteSuperImunisasi);
//superUtangPiutang
...
router.delete("/superUtangPiutang/delete/:id", dokumenController.deleteSuperUtangPiutang);
//suketjabatan
...
router.delete("/suketdomisili/delete/:id", dokumenController.deleteSuketDomisili);
//suketGhoib
...
router.delete("/suketkehilanganstpd/delete/:id", dokumenController.deleteSuketKehilanganStpd)
//suketkehinlangankk
...
router.delete('/suketkehilangankk/delete/:id', dokumenController.deleteSuketKehilanganKK);
//suketkekerabatan
...
router.delete('/suketkekerabatan/delete/:id', dokumenController.deleteSUketKekerabatan);
//suketlahirdesa
...
router.delete('/suketlahirdesa/delete/:id', dokumenController.deleteSuketLahirDesa);
//suketlokasitanah
...
router.delete('/suketlokasitanah/delete/:id', dokumenController.deleteSuketLokasiTanah);
//suketmenantu
...
router.delete("/suketpendudukliar/delete/:id", dokumenController.deleteSuketPendudukLiar);
//suketpenegasanwil
...
router.delete("/suketpenegasanwil/delete/:id", dokumenController.deleteSuketPenegasanWil);
...
router.delete("/suketaktifperusahaan/delete/:id", dokumenController.deleteSuketAktifPerusahaan);
//sukettelahmenikah
...
router.delete("/sukettelahmenikah/delete/:id", dokumenController.deleteSuketTelahMenikah);
//suketpisahrumah
...
router.delete("/suketpernyataanwaris/delete/:id", dokumenController.deleteSuketPernyataanWaris);
//suketpengurusanpbb
...
router.delete("/suketpengurusanpbb/delete/:id", dokumenController.deleteSuketPengurusanPBB);
//suketpengurusankk
